...
export const RangePicker: React.FC<RangePickerProps> = memo(
  ({
    ...
    return (
      <div className="react-datetime-range__range" style={style}>
        <span
          className={`react-datetime-range__range-input-wrapper ${
            disabled && "disabled"
          }`}
        ...
        >
          <input
            ...
            className={`react-datetime-range__range-input ${
              disabled && "disabled"
            }`}
            value={valueStart}
          />
          <span className="react-datetime-range__range-input-separator">
            {" "}
            ~{" "}
          </span>
          <input
          ...
          {!isInitial && !isEmpty ? (
            <svg
              className={`react-datetime-range__clear ${
                disabled && "disabled"
              }`}
              width="15"
              height="15"
            ...
            >
              <path
                className="react-datetime-range__icon-fill"
...
const RangePickerComponent: React.FC<RangePickerComponentProps> = memo(
  ({
    ...
    const componentClass = useMemo(
      () => cx("react-datetime-range", internalShow && "visible"),
      [internalShow]
    );
      ...
      <div className={componentClass}>
        ...
        >
          ...
          {(showOnlyTime || type === TYPES[1]) && (
            <div className="react-datetime-range__time-piker">
              <RangeTime
                startDatePickedArray={startDatePickedArray}
                endDatePickedArray={endDatePickedArray}
                handleChooseStartTimeHour={handleChooseStartTimeHour}
        ...
        <div className="react-datetime-range__button-wrapper">
          {!showOnlyTime && (
            <div
              className={cx(
                "react-datetime-range__button",
                "react-datetime-range__button--type",
                !selected && "disabled"
              )}
          ...
          <div
            className={cx(
              "react-datetime-range__button",
              "react-datetime-range__button--confirm",
              !selected && "disabled"
            )}
